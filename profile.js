        ...
        <div class="card">
              ...
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                <img
                  ...
                  alt=""
                />
                <b>Name :  <span class="text-secondary">${profileName}</span></b>
                <b>User Name :  <span class="text-secondary">${profileUserName}</span></b>
                <b>Email : <span class="text-secondary">${profileEmail}</span></b>
                <b>Posts Count : <span class="text-secondary">${profilePostsCount}</span></b>
                <b>Comments Count : <span class="text-secondary">${profileCommentsCount}</span></b>
              </div>
            </div>
            <!-- user card -->
`;
